...
oft_k:a.oft_k,identificationType:"sendlog"})),window.localStorage.setItem("isContactIsIdentified","1"))}}function q(c){if(a())console.log("Token already sent to server so won't send it again unless it changes");else{console.log("Sending token to server...");var d=window.localStorage.getItem("ContactIdentifier");null!=d&&(d=JSON.parse(d));c={ApplicationId:"3238:vvz7WQEc3UPHmb7gf9CzHMlbJny261Ee",ContactIdentifier:null!=d?d.oft_id+":"+d.oft_k:null,Token:c,Domain:location.host,Language:(window.navigator.userLanguage||window.navigator.language).substring(0,
2)};$.ajax({type:"POST",url:"https://lightspeed.dev.ofsys.com/webservices/ofc4/mobile.ashx?method=WPSetToken",data:JSON.stringify(c),success:function(a,c,e){console.log(a);console.log(c);console.log(e);null!=d&&b(!0)},error:function(a,b,c){console.log(a);console.log(b);console.log(c);console.log("An error occurred while transferring the token. Check your configuration.")},dataType:"json"})}}function a(){return 1==window.localStorage.getItem("sentToServer")}function b(a){window.localStorage.setItem("sentToServer",
a?1:0)}c.QueryString=m;firebase.initializeApp({
  ...
  });var d=firebase.messaging();d.onTokenRefresh(function(){d.getToken().then(function(a){b(!1);q(a)})["catch"](function(a){console.log("Unable to retrieve refreshed token ",a)})});d.onMessage(function(a){console.log("Message received. ",a)});c.Init=function(){t()||l()};c.IsIdentify=t;c.tryIdentify=l;c.sendTokenToServer=q;c.isTokenSentToServer=a;c.setTokenSentToServer=b;c.requestPermission=function(){d.requestPermission().then(function(){d.getToken().then(function(a){a?
q(a):(console.log("No Instance ID token available. Request permission to generate one."),b(!1))})["catch"](function(a){console.log("An error occurred while retrieving token. ",a);showToken("Error retrieving Instance ID token. ",a);b(!1)})})["catch"](function(a){console.log("Unable to get permission to notify.",a)})};c.deleteToken=function(){d.getToken().then(function(a){d.deleteToken(a).then(function(){console.log("Token deleted.");b(!1)})["catch"](function(a){console.log("Unable to delete token. ",
a)})})["catch"](function(a){console.log("Error retrieving Instance ID token. ",a)})};window.addEventListener("message",function(a){console.log("message received");console.log(a);if("undefined"!==typeof a&&null!=a){var b=a;if(a.constructor==="".constructor)try{b=JSON.parse(a)}catch(k){return}"undefined"!==typeof b.data&&null!=b.data&&"di:"==(""+b.data).substr(0,3)&&d.getToken().then(function(b){b?a.source.postMessage("di:"+JSON.stringify({event:"sendtoken",value:b}),"*"):a.source.postMessage("di:"+
JSON.stringify({event:"sendtoken",value:null}),"*")})["catch"](function(b){a.source.postMessage("di:"+JSON.stringify({event:"sendtoken",value:null}),"*")})}})})(window.ofsysPush.Notification);window.ofsysPush.dom.onLoad(function(){window.ofsysPush.Notification.Init()});
